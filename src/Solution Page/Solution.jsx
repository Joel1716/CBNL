          ...
          <div className="all-solutions">
            <div className="row grid-two-cols">
              <div className="solution-info">
                ...
                <h4>
                  Seamless wireless links across estates, campuses, and
                  facilities
                </h4>
                <p>
            ...
            <div className="row grid-two-cols">
              ...
              <div className="solution-info">
                ...
                <p>
                  ...
                  access essential internet services promoting digital
                  inclusion, education, and economic growth. Designed for fast
                  deployment and rugged environments, our networks ensure strong
                  coverage, reliability, and scalability in even the most
            ...
            <div className="row grid-two-cols">
              <div className="solution-info">
                ...
                <p>
                  As cities adopt smarter technologies, we support their
                  backbone: connectivity. From traffic lights and environmental
                  sensors to CCTV and public Wi-Fi, our wireless systems connect
                  critical infrastructure in real-time. High throughput and low
                  latency allow cities to operate more efficiently, keep
                  residents safe, and gather valuable data for planning and
                  management.
                </p>
              </div>
              <div className="image-box">
            ...
            <div className="row grid-two-cols">
              ...
              <div className="solution-info">
                ...
                <p>
                  ...
                  solutions offer private, high-speed wireless access tailored
                  for businesses that need real-time data flow, cloud services,
                  and remote collaboration. Whether you're in finance,
                  logistics, education, or healthcare, our enterprise-grade
                  networks ensure superior uptime, data security, and
                  scalability — all without relying on fiber or digging.
                </p>
              </div>
            </div>
            {/*  */}
            <div className="row grid-two-cols">
              <div className="solution-info">
                ...
                <p>
                  ...
                  Fiber delivers core connectivity, while wireless fills the
                  gaps — maintaining quality and coverage. This model is
                  especially effective for semi-urban expansion, backup
                  connectivity, or dense areas requiring fast, reliable
                  delivery.
                </p>
              </div>
              <div className="image-box">
            ...
            <div className="row grid-two-cols">
              ...
              <div className="solution-info">
                ...
                <p>
                  CBNL's wireless backhaul solutions connect mobile base
                  stations to the core network, enabling operators to extend
                  coverage and boost network capacity in urban and rural areas.
                  Designed to handle high traffic loads and future growth, our
                  solutions ensure mobile users enjoy seamless voice, data, and
                  video services,even during peak usage periods. They are ideal
                  for 4G LTE and 5G deployments, supporting rapid rollout and
